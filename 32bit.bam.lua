...
function build(settings)
	...
	client_exe = Link(client_settings, "32bit_teeworlds_catching", game_shared, game_client,
		engine, client, game_editor, zlib, pnglite, wavpack,
		client_link_other, client_osxlaunch)

	server_exe = Link(server_settings, "32bit_teeworlds_catching_srv", engine, server,
