...
image_fileicons = Image("fileicons", "file_icons.png")image_speedup_arrow = Image("speedup_arrow", "editor/speed_arrow.png")container.images.Add(image_null)
...
container.images.Add(image_fileicons)container.images.Add(image_speedup_arrow)
...
set_fileicons = SpriteSet("fileicons", image_fileicons, 8, 1)set_speedup_arrow = SpriteSet("speedup_arrow", image_speedup_arrow, 1, 1)container.spritesets.Add(set_particles)
...
container.spritesets.Add(set_fileicons)container.spritesets.Add(set_speedup_arrow)
