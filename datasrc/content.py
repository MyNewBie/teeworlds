...
image_demobuttons = Image("demobuttons", "demo_buttons.png")image_speedup_arrow = Image("speedup_arrow", "editor/speed_arrow.png")
...
container.images.Add(image_demobuttons)container.images.Add(image_speedup_arrow)
...
set_demobuttons = SpriteSet("demobuttons", image_demobuttons, 5, 1)set_speedup_arrow = SpriteSet("speedup_arrow", image_speedup_arrow, 1, 1)
...
container.spritesets.Add(set_demobuttons)container.spritesets.Add(set_speedup_arrow)
