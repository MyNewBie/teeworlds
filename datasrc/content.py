...
image_guibuttons = Image("guibuttons", "gui_buttons.png")image_speedup_arrow = Image("speedup_arrow", "editor/speed_arrow.png")
...
container.images.Add(image_guibuttons)container.images.Add(image_speedup_arrow)
...
set_guibuttons = SpriteSet("guibuttons", image_guibuttons, 16, 2)set_speedup_arrow = SpriteSet("speedup_arrow", image_speedup_arrow, 1, 1)
...
container.spritesets.Add(set_guibuttons)container.spritesets.Add(set_speedup_arrow)
