...
Import("other/sdl/sdl64.lua")
Import("other/freetype/freetype64.lua")
...
function build(settings)
	...
	client_exe = Link(client_settings, "teeworlds_x86_64", game_shared, game_client,
		engine, client, game_editor, zlib, pnglite, wavpack,
		client_link_other, client_osxlaunch)

	server_exe = Link(server_settings, "teeworlds_srv_x86_64", engine, server,
